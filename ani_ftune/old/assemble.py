...
path = Path('/home/ignacio/RemoteMachines/hpg-blue/torchani-runs/trials-processed-with-bb-ensemble')
best_checkpoints = []
...
ensemble_state_dict = combine_state_dicts(sorted(p for p in dst_path.iterdir() if not p.stem.startswith('ensemble')))
